 ...
 *
 *  Solution 1  is to use conditional closing, to insure that outChannel will accept all packets
 ...
 *  Solution 2  set and count sources, to insure that outChannel will accept all packets
 *  emitted all its sources
       Example 6b:
